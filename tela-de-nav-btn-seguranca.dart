            ...
            child: Center(
              child: Stack(
                ...
                children: [
                  ...
                  // Botão central - Emergency - Aqui faz a navegação
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                  ...
                  Positioned(top: 10, child: Image.network(sunIcon, width: 35, height: 35)),
                  Positioned(bottom: 20, child: Image.network(shieldIcon, width: 35, height: 35)),
                  Positioned(left: 10, child: Image.network(mapIcon, width: 35, height: 35)),
                  Positioned(right: 10, child: Image.network(groupIcon, width: 35, height: 35)),
                  Positioned(
                      bottom: 50,
                      right: 50,
